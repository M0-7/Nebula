...
class Help(commands.Cog): 
    ...
    async def help(self,ctx):
      ...
      ehelp.add_field(name="📚 **Phrases[5]**",value="`!aniquote`, `!quote`, `!joke`, `!roast`, `!weather`", inline=False)
      ...
      ehelp.add_field(name="🔗 **Links[4]**", value="`!moaz`, `!reyan`, `!bilal`, `!shayan`, `!avatar`", inline=False)
      ehelp.add_field(name="🧩 **Utility[4]**", value="`!ping`, `!lock`, `!unlock`")
